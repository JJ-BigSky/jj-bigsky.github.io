...
(function () {
  ...
  const CLAIMS = [
    ...
    { id: "gaussian-splat", s: "imagine", r: "reported", checked: C, claim: "3D Gaussian splatting produces digital twins from sparse images in minutes, convertible to collision-ready geometry for physics engines.", note: "Practical today, not a roadmap.", used: ["/world-models/"], src: [["A high-fidelity digital twin for robotic manipulation based on 3DGS", "https://arxiv.org/abs/2601.03200"], ["3D Gaussian Splatting in Robotics: a survey", "https://arxiv.org/pdf/2410.12262"]] },
    ...
    { id: "generalist-landscape", s: "hub", r: "reported", rots: true, checked: C, claim: "The generalist policy field is flow-matching VLAs, open-weight cross-embodiment models, diffusion policies, and vendor stacks that ship with the hardware.", note: "Written without model names on purpose. That's a feature.", used: ["/physical-ai/"], src: [["A Survey on Vision-Language-Action Models for Embodied AI", "https://arxiv.org/pdf/2405.14093"]] }
  ];
  const EVENTS = [
